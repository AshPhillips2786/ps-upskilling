...
class PDF(FPDF):
    ...
    def details(self, syllabus, squad):
        ...
        # self.cell(15, 10, 'Python', 0, 0, 'L')
        # self.ln()
        # self.cell(15, 10, 'Member', 0, 0, 'C')
        # self.cell(15, 10, 'P-001', 0, 0, 'C')
        # self.cell(15, 10, 'P-002', 0, 0, 'C')
        # self.cell(15, 10, 'P-003', 0, 0, 'C')
        # self.ln()
        # self.cell(15, 10, 'AP', 0, 0, 'C')
        # self.cell(15, 10, 'C', 0, 0, 'C')
        # self.cell(15, 10, 'C', 0, 0, 'C')
        # self.cell(15, 10, '', 0, 0, 'C')
        # self.ln()
        # self.cell(15, 10, 'ES', 0, 0, 'C')
        # self.cell(15, 10, 'C', 0, 0, 'C')
        # self.cell(15, 10, '', 0, 0, 'C')
        # self.cell(15, 10, '', 0, 0, 'C')
        # self.ln()
